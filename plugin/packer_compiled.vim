...
_G.packer_plugins = {
  ["coc.nvim"] = {
    loaded = true,
    path = "/home/amitav/.local/share/nvim/site/pack/packer/start/coc.nvim"
  },
  ["colorbuddy.vim"] = {
    loaded = true,
  ...
  ["express_line.nvim"] = {
    loaded = true,
    path = "/home/amitav/.local/share/nvim/site/pack/packer/start/express_line.nvim"
  },
  ["fzf-checkout.vim"] = {
    loaded = true,
    path = "/home/amitav/.local/share/nvim/site/pack/packer/start/fzf-checkout.vim"
  },
  gruvbox = {
    loaded = true,
  ...
  ["vim-jsx-improve"] = {
    loaded = true,
    path = "/home/amitav/.local/share/nvim/site/pack/packer/start/vim-jsx-improve"
  },
  ["vim-react-snippets"] = {
    loaded = true,
    path = "/home/amitav/.local/share/nvim/site/pack/packer/start/vim-react-snippets"
  },
  ["vim-startify"] = {
    loaded = true,
